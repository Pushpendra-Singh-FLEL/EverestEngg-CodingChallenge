<style>
    /* enhancement-box
    Use it when:
    - Suggesting a possible feature or design improvement
    - Brainstorming extensions to existing functionality
    - Highlighting optional upgrades or future evolution points
    */
.enhancement-box {
  background: #e8f0fe;
...
/* limitation-box
    Use it when:
    - Highlighting edge cases or caveats in the current design
    - Describing technical or practical tradeoffs
    - Noting potential points of failure, scaling constraints, or safety concerns
    */
.limitation-box {
  background: #fff3e0;
...
/* tradeoff-box
    Use it when:
    - Presenting mutually exclusive design decisions
    - Explaining why a feature was omitted or deferred
    - Capturing context-specific benefits/costs of an approach
    */
.tradeoff-box {
  background: #ede7f6;
...
.limitation-icon::before {
  content: "\26A0 ";
  /* ⚠️ */
  margin-right: 4px;
}

.tradeoff-icon::before {
  content: "\2696 ";
  /* ⚖️ */
  margin-right: 4px;
}
...
/* Reset strong inside caution/info/tip boxes */
.enhancement-box strong,
.limitation-box strong,
.tradeoff-box strong {
  color: inherit;
  /* Use the parent text color */
  font-weight: bold;
  /* Keep the bold emphasis */
}
</style>
